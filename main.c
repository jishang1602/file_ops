/*
* Author: Jishang Desai
* This program is just a use cases of the file operation in the C code.
* 
* This program open a text file inputdata.txt open the first digit to get the 
* number of elements in the file. This all elements are int type and stored into 
* the malloc. Here i use the malloc as because the size of the elements may change.
* Finding the average of the array and Finding the max value from the array.
*
* Also storing the average value in double and MAX in the int to another file answer-hw3
*  
*/
/*For the standard intput io related , data type and file related operation to do in the program*/
#include <stdio.h> 
